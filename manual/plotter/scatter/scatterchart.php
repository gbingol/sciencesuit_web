...
<p>Scatter charts are very useful to show the relationship between different sets of values. </p>
...
<p>Let's assume you have the following time and temperature data:</p>
...
<p>Selecting "<em>Add New Series</em>" will show the following dialog:</p>
...
<h3 id="Changing_Chart_Type">B) Changing Chart Type</h3>
...
<p>Please note that, it is not possible to set line thickness and marker size to zero at the same time. 
    The rationale for this is that a series must be represented at any time either by a marker or a line or both.</p>
...
<h3 id="Axis_Options">C) Axis Options</h3>

<p>
    The plotter allows changing axis options (horizontal or vertical). Here, changing the properties of the horizontal axis 
    will be presented. Similar steps are followed to modify the properties of the vertical axis.
</p>
...
<h3 id="Menu_Options">D) Context-Menu Options</h3>
...
<p>
    <a href="#Updating_Series">Updating</a>, <a href="#Formatting_Series">formatting</a> and <a href="#Deleting_Series">deleting</a> series 
    have already been presented. <a href="#trendlines">Adding trendlines</a> is presented in the next section.
</p>
...
<p>
    <a href="#addnewseries">Add New Series</a> and <a href="#addvisibleselection">Add Visible Selection</a> have already been presented in detail.
</p>

 <p>&nbsp;</p>

<p>For example, to format the horizontal gridlines, just select <em>"Format Horizontal Gridlines..."</em> option and a dialog will be shown</p>
...
<h3 id="Selection">A) Selection</h3>
...
<h3 id="Using_Only_Commands">B) Using Only Commands</h3>
<p>
    In order to plot multiple series using only commands, you can use <em>hwnd</em> property of <a href="../../std/funcs/scatter.php">std.scatter</a> command. 
    Suppose you want to plot F- and normal distribution on the same plot window. The command sequence that will generate the chart with multiple series:
</p>
...
<h3 id="Selection_Command">C) Selection & Command</h3>
<p>
...
<p>
    ...
    As described in <a href="#plottingsimplechart">how to plot a simple chart</a> make the necessary selections.
</p>

<img src="images/multipleseries_mixedmode_addseries.png" alt=""/>

<p>&nbsp;</p>
<p><b>3)</b> Click "<em>OK</em>" button and a new series will be added to the same plot window as shown below.</p>

<img src="images/multipleseries_mixedmode_plotwindow_2series.png" alt=""/>

<p>&nbsp;</p>

<p>Please note that, it is also possible to use "Add Visible Selection" option, to add another series to an existing chart.</p>
...
<p>
    When possible, the intercept can be set to a custom value. Based on the selected trendline, the R<sup>2</sup> (goodness of fit) and equation can be displayed on the chart.
</p>
...
<h3 id="Adding_Trendlines">A) Adding Trendlines</h3>
...
<h3 id="Changing_Trendline_Type">B) Changing Trendline Type</h3>
...
<h3 id="Changing_Line_Properties">C) Changing Line Properties</h3>
...
<h3 id="Displaying_R2_and_Equation">D) Displaying R2 and Equation</h3>
...
<h3 id="Changing_Intercept">E) Changing Intercept</h3>
...
<h3 id="Exporting_the_Equation"> F) Exporting the Equation</h3>
