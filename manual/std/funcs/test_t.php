...
<p class="funcsignature">
    test_t{x=, [y=], varequal=<span class="auto-style6">true</span>, alternative="two.sided", mu=<span class="auto-style15">0</span>, conflevel=0.95, paired=<span class="auto-style6">false</span>}
</p>
...
<p>
    If the standard deviation of the population is not known we use the one-sample t-test procedure to test &mu;=&mu;<sub>0</sub>.
</p>
...
<h3>Paired t-test</h3>
<p>
    Suppose that a given experiment consists of two dependent random samples X<sub>1</sub>, X<sub>2</sub>,…, X<sub>n</sub> and Y<sub>1</sub>, Y<sub>2</sub>,…,Y<sub>m</sub>. 
...
<p class="CodeCommand">
    ...
    &gt;&gt;tbl <br />
    tcritical=-2.80868&nbsp;&nbsp;&nbsp; N=8&nbsp;&nbsp;&nbsp; stdev=3.62531&nbsp;&nbsp;&nbsp; mean=5&nbsp;&nbsp;&nbsp; CI_lower=1.96917&nbsp;&nbsp;&nbsp; CI_upper=8.03083&nbsp;&nbsp;&nbsp; SE=1.28174 </p>
...
<p>
    ...
    group and treatment group.<span class="auto-style3"><br></span>
...
<table cellpadding="0" cellspacing="0" class="auto-style2" style="width: 384pt" width="512">
    
    <tr>
        <td class="auto-style1" colspan="4" height="20" style="height: 15.0pt; width: 192pt" width="256">
        <strong>Treatment Group</strong></td>
        <td class="auto-style8" colspan="4" style="width: 192pt" width="256">
            <strong>Control group</strong></td>
    </tr>
    <tr>
            <td  height="20" style="height:15.0pt" class="auto-style9">24</td>
    ...
    <tr>
            <td  height="20" style="height:15.0pt" class="auto-style9">43</td>
    ...
    <tr>
            <td  height="20" style="height:15.0pt" class="auto-style9">58</td>
    ...
    <tr>
            <td  height="20" style="height:15.0pt" class="auto-style9">71</td>
    ...
    <tr>
            <td  height="20" style="height:15.0pt" class="auto-style9">49</td>
...
<p class="CodeCommand">
    ...
    n1=21&nbsp;&nbsp;&nbsp; n2=23&nbsp;&nbsp;&nbsp;
    tcritical=2.31089&nbsp;&nbsp;&nbsp; CI_lower=1.22637&nbsp;&nbsp;&nbsp; CI_upper=18.6825&nbsp; 
</p>
